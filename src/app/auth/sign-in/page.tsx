...
export default function SignIn() {
  ...
  const [isRedirecting, setIsRedirecting] = useState<OAuthStrategy | null>(
    null,
  );
  ...
  return (
    <>
      <CardHeader>
        ...
        <CardDescription>to continue to Bird</CardDescription>
      </CardHeader>
      <CardContent>
        {error && (
        ...
        <div className="flex flex-col space-y-2">
          ...
          >
            ...
            {isRedirecting === "oauth_github" && (
              <Loader2 className="ml-auto h-4 w-4 animate-spin" />
            )}
          </Button>
          <Button
            className="w-full justify-start"
            onClick={() => handleSignIn("oauth_discord")}
            disabled={!!isRedirecting}
          >
            <svg
              aria-hidden="true"
